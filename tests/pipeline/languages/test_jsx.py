"""Tests for JSX support (processed via the javascript grammar)."""
...
fixture_comprehensive = Path(__file__).parent.parent.parent / "fixtures" / "javascript" / "comprehensive.jsx"
...
def test_jsx_rules_extract(rules):
    """Test that JSX files can be processed with the javascript grammar."""
