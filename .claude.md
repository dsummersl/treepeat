...
**covey** is a code similarity detection tool that identifies structurally similar code blocks across and within programming languages. Unlike traditional duplicate detection tools that only find textual matches, covey uses Tree-sitter ASTs to detect semantic and structural similarities even when identifiers, literals, or function names differ.
...
```
covey/          # Main package source code
tests/          # Test files (mirror covey/ structure)
