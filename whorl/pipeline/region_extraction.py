...
def _create_unmatched_region(
    parsed_file: ParsedFile,
    range_start: int,
    range_end: int,
) -> ExtractedRegion:
    """Create a single region for an entire unmatched range.

    This region will be shingled, and then windows will be created from the shingles.
    """
